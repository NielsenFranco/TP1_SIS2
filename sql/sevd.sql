...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-05-2025 a las 00:47:21
...
(22, 'pepe', 'pepep', '0000-00-00', '', '', 'afsdfasdfasdf@gmail.com', 4, 12234544, 48, 0);
...
(48, 'pepe', '$2y$10$6sDork8xz69Zp7d4IsSUBenXv.8C3aqhRhN2LNaNzsiefO0PIRq4K', 1, 12234544, 'pepep', 'afsdfasdfasdf@gmail.com', 'Pepex', 'verificado');
...
--
ALTER TABLE `mesas`
  MODIFY `idmesa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
